...
- 0008: / 홈 페이지 (유형 바로가기 + 최근 계산 + 배너) (files: src/pages/Home.tsx)
- 0010: /result 페이지 (추천 금액 + 근거 + 액션 분기) (files: src/pages/Result.tsx, src/components/ResultContent.tsx)
- 0011: /record/new 페이지 (기록 폼 + 검증 + 저장) (files: src/pages/RecordNew.tsx, src/components/RecordForm.tsx, src/lib/validation.ts)
- 0012: /history 페이지 (탭 필터 + 목록 + 삭제 + 배너) (files: src/pages/History.tsx, src/components/RecordList.tsx, src/components/RecordActionSheet.tsx)
- 0013: /stats 페이지 (무료 요약 + 건수 게이트 + 리워드 게이트) (files: src/pages/Stats.tsx, src/components/StatsDetail.tsx, src/hooks/useStatsUnlock.ts)
...
// src/components/RecordActionSheet.tsx
...
// src/components/ResultContent.tsx
